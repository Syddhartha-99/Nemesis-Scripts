...
namespace SG
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        public CapsuleCollider characterRootCollider;
        ...
        public void Start()
        {
            ...
            Physics.IgnoreCollision(characterCollider, characterCollisionBlocker);
            Physics.IgnoreCollision(characterRootCollider, characterCollisionBlocker);
        }
